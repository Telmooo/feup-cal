...
arestas utilizamos um $vectors$ que contém um pointer para o respetivo elemento.
...
\subsection{Aresta}
Possuem um ID que permite a sua identificação, assim como um vértice de destino, o peso do tempo e o da distância. 
...
Os mapas são lidos atrasvés de ficheiros de texto que possuem informação sobre os vértices e sobre as arestas.
Também existem ficheiros que possuem informação sobre a localização da central e sobre os pedidos de transporte de prisioneiros. 
