...
\section{Grafo}
O grafo que fora utilizado no desenvolvimento deste projeto é uma adaptação de um grafo fornecido previamente adaptado ao nosso problema. Para guardar os vértices e as 
arestas utilizamos $vectors$ que contém um pointer para o respetivo elemento.

\section{Departamento}
A classe \textit{Departamento} é a principal classe do deste trabalho. Através desta classe conseguimos ter acesso a todas as carrinhas que vão atender os diversos pedidos de
...
O algoritmo $Nearest Neighbour$ faz uso de $MultiMaps$ e $Sets$. Uma vez que é possível que
