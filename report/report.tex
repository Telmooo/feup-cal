...
\subsection{Grafo}
Partindo da central, eliminar tudo aquilo que não seja alcançável 
Tem de ser tudo fortemente conexo

\subsection{Pedidos de transporte de prisioneiros}
Remover todos os pedidos que não pertençam ao grafo pre processado.
Ordenar os prisioneiros por tipo para no caso de existir uma carrinha com lugar livre este seja ocupado.
